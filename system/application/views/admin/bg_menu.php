	<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url()?>index.php/MasterMesin/index">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Master Mesin</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Master 2<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Sub Master 2</a>
                                </li>
                                <li>
                                    <a href="morris.html">Sub Master 2</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
