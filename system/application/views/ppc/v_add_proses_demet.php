      ...
      <div class = "row">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class="form-control" name="urutanProduksi" value="<?php if($demet!="") echo $demet['URUTAN_PRODUKSI']; ?>" placeholder="Urutan Produksi">
          </div>
          <div class="form-group">
            <label>Waste</label>
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="targetProduksi" value="<?php if($demet!="") echo $demet['KECEPATAN_MESIN']; ?>" readonly>
          </div>
        ...
        <div class="form-group">
            <label>Hasil</label>
            <input class="form-control" name="hasil" value="<?php if($demet!="") echo $demet['HASIL']; ?>" id="hasil" readonly>
        </div>
          <div class="form-group">
            <label>Stel Bahan</label>
            <input class="form-control" name="stelBahan" value="<?php if($demet!="") echo $demet['STEL_BAHAN']; ?>" id="stelBahan" readonly>
          </div>
          <div class="form-group">
            <label>Lama Proses</label>
            <input class="form-control" name="lamaProses" value="<?php if($demet!="") echo $demet['LAMA_PROSES']; ?>" id="lamaProses" readonly>
          </div>
          <div class="form-group">
            <label>Total Waktu</label>
            <input class="form-control" name="totalTime" value="<?php if($demet!="") echo $demet['TOTAL_WAKTU']; ?>" id="totalTime" readonly>
          </div>
...
<script type="text/Javascript">
  ...
  function countSpeed(val,mesin,waktuNaik,waktuMendidih){
    ...
    stelBahan = (((hasilProsesEmboss/6000)*waktuNaik) + ((hasilProsesEmboss/6000)/shift*waktuMendidih))/24;
